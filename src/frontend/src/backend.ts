...
export class Backend implements backendInterface {
    ...
    async saveProject(arg0: string, arg1: string, arg2: string, arg3: string, arg4: Array<AssetMetadata>, arg5: Array<AssetMetadata>): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.saveProject(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateProjectText(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProjectText(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
